    ...
    public static function defaults(): array
    {
        return [
            ...
            'trading' => [
                ...
                'enable_sentiment' => true,            // لایهٔ هفتم: سنتیمنت آن‌چین (v5.7)
            ...
            'learning' => [
                'enabled' => true,             // موتور یادگیری تطبیقی (نسخهٔ ۵٫۶)
                'eta' => 0.12,                 // نرخ یادگیری
                'min_samples' => 12,           // حداقل نمونه قبل از تطبیق وزن
                'window' => 400,               // پنجرهٔ داوری‌های اخیر
                'mult_min' => 0.25,            // کف ضریب فیلتر
                'mult_max' => 2.5,             // سقف ضریب فیلتر
                'quarantine_below' => 0.40,    // قرنطینه: درست‌بودن زیر این
                'quarantine_min' => 30,        // قرنطینه: حداقل نمونه
                'recover_above' => 0.52,       // بازیابی از قرنطینه
                'half_life_days' => 45,        // نیم‌عمر حافظهٔ داوری‌ها (۵٫۷)
                'wf_fraction' => 0.30,         // سهم بخش آزمون walk-forward (۵٫۷)
                'wf_min_val' => 8,             // حداقل نمونهٔ آزمون
                'wf_gate' => 0.45,             // درستی آزمون زیر این = تعویق ارتقا
                'near_miss' => true,           // ژورنال فرصت‌های نزدیک (۵٫۷)
                'regime_weights' => true,      // ضرایب وابسته به رژیم (۵٫۷)
                'disabled' => [],              // کلید فیلترهای غیرفعال دستی
                'overrides' => [],             // ضریب دستی per-filter
            ],
            'notify' => [
