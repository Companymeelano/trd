...
<section class="tab-panel card-3d section" id="tab-pricing" hidden>
    ...
    <div class="grid grid--2">
        ...
        <div class="stack" style="gap:12px">
            ...
            <div style="display:flex;align-items:center;gap:9px">
                <label class="switch"><input type="checkbox" id="pr_sent" <?= Config::get('trading.enable_sentiment', true) ? 'checked' : '' ?>><span class="switch__track"></span></label>
                <span style="font-size:12px;color:var(--text-dim)">لایهٔ هفتم — سنتیمنت آن‌چین و ریسک خبری (v5.7)</span>
            </div>
        </div>
    </div>
