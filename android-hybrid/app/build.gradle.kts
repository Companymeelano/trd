...
android {
    namespace = "ir.meelano.hybrid"
    compileSdk = 35

    defaultConfig {
        applicationId = "ir.meelano.hybrid"
        minSdk = 24
        targetSdk = 35
        versionCode = 600
        versionName = "6.0.0"
...
dependencies {
    ...
    // WebViewAssetLoader: serves the bundled offline console + bridge script on
    // a synthetic https origin instead of file://.
